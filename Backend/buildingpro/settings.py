...
MIDDLEWARE = [
    ...
    'authentication.middleware.StaticFilesMiddleware',  # ← Agregar esto
...
if DEBUG:
    STATIC_ROOT = os.path.join(BASE_DIR, '..', 'Frontend')  # Para collectstatic
else:
...
# buildingpro/settings.py - Reemplazar la configuración de email
...
# Si no hay credenciales, fallback a consola
if not EMAIL_HOST_USER or not EMAIL_HOST_PASSWORD:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    print("⚠️  Usando consola para emails (configura credenciales en .env)")
else:
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
